...
import com.googlecode.spektom.gcsearch.ui.GCSearchResultPage;

public class TreeViewerNavigator implements INavigate {
	private GCSearchResultPage page;
	private TreeViewer viewer;

	public TreeViewerNavigator(GCSearchResultPage page, TreeViewer viewer) {
		this.page = page;
		this.viewer = viewer;
	}
	...
	private boolean hasMatches(TreeItem item) {
		...
		return page.getDisplayedMatchCount(element) > 0;
	}
